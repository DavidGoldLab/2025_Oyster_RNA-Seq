...
write.table(data, file="1_Carbonic_Anhydrases.txt.log2.centered.dat", quote=F, sep='	');
if (nrow(data) < 2) { stop("
...
heatmap_data = data
pdf("1_Carbonic_Anhydrases.txt.log2.centered.genes_vs_samples_heatmap.pdf")
...
", "1_Carbonic_Anhydrases.txt.log2.centered" ) )
dev.off()
